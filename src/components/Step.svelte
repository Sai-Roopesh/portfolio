...
>
    <div
        class="bg-slate-950 grid place-items-center px-4 text-5xl md:text-6xl -mt-10 sm:-mt-12 md:-mt-12 lg:-mt-16 mx-auto duration-200"
    >
        <i class={step.icon}></i>
    </div>
    <h3 class="font-medium text-xl sm:text-2xl md:text-4xl">{step.name}</h3>
    <slot />
    <div class="flex-1 flex justify-between gap-4 items-center">
        ...
        >
            <p class="relative z-4" href={step.href}>Go to &rarr;</p>
        </div>
    </div>
</a>
